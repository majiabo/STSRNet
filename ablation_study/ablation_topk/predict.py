...
import sys
sys.path.append('../')
from attention_strategy.ablation_topk.net import STTRNetAblationStudyT
...
import cv2
import torch
from attention_strategy.ablation_topk.configs import AblationT4
...
G = STTRNetAblationStudyT(sr=True, out_num=len(args.out_img), top_k=args.top_k).cuda()
