...
sys.path.append('../')
from attention_strategy.ablation_input.configs import One
from attention_strategy.ablation_input.net import STTRNetAblationStudy
...
optimizerG = torch.optim.Adam(G.tail.parameters(), lr=lr)
